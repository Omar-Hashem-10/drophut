...
<div class="wrapper">
  ...
  <?php
      ...
      $sql = Database::select("*", "users", "user_id", $admin_id);
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="logout.php?id=<?= $admin_id; ?>" class="nav-link">Logout</a>
      </li>
    </ul>
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="add_social_media.php" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>Add Social Media</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="view_social_media.php" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
            <p>View Social Media</p>
          </a>
        </li>
      </ul>
    </li>
...
<li class="nav-item">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="add_description.php" class="nav-link">
        <i class="far fa-circle nav-icon"></i>
        <p>Add Description</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="view_descriptions.php" class="nav-link">
        <i class="far fa-circle nav-icon"></i>
